...
#
# import crf_train
from src.text_summarizers.GraphicalModel import crf_test
from src.text_summarizers.GraphicalModel import k_mix_model_test
...
if __name__ == '__main__':
    ...
    output_path = root_path + '/tests/summariser_tests/output/result_graphical_case_4.txt'

    summary = get_summary(input_path)
