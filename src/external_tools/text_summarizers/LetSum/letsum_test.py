...
from src.text_summarizers.LetSum.formulated_constants import *
from src.text_summarizers.LetSum.formulated_constants import include_toggled_phrases, include_toggled_pairs
...
cue_phrases = categorical_phrases
cue_pairs = categorical_pairs
...
if __name__ == '__main__':
    ...
    # path to given sample input
    # input_path = root_path + '/tests/summariser_tests/input/sample_input_repo.txt'

    input_path = root_path + '/data/sample_judgement_text_cleaned/case_4.txt'

    output_path = root_path + '/tests/summariser_tests/output/result_letsum_case_4.txt'

    if len(sys.argv) > 1:
        file = sys.argv[1]

    summary = LetSum(input_path)
